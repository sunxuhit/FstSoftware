...
/* Generated from ../O.Common/istCooling.dbd */
...
int istCooling_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/sysuser/epics.3.14.12.1/hft_sc/IST/ISTCOOLING";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"istCooling_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    istCooling_registerRecordDeviceDriver(*iocshPpdbbase);
}
