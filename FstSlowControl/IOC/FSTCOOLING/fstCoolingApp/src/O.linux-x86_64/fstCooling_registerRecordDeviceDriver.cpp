...
/* Generated from ../O.Common/fstCooling.dbd */
...
int fstCooling_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"fstCooling_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    fstCooling_registerRecordDeviceDriver(*iocshPpdbbase);
}
