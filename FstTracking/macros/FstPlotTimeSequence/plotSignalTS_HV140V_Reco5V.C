...
void plotSignalTS_HV140V_Reco5V()
{
  const int numOfTS = 7;
  string date[numOfTS] = {"0329","0520","0521","0602_1","0603","0604_0","0604_1"};
  ...
  string outputname = "./figures/SignalTS_140V_Reco5V.pdf";
  ...
  string output_start = "./figures/SignalTS_140V_Reco5V.pdf[";
  ...
  c_Signal_TS->cd(1);
  {
    TLegend *leg_FST = new TLegend(0.6,0.7,0.8,0.9);
    leg_FST->SetBorderSize(0);
    leg_FST->SetFillColor(10);
  ...
  string output_stop = "./figures/SignalTS_140V_Reco5V.pdf]";
