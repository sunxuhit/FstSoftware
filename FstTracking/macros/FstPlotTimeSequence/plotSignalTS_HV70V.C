...
void plotSignalTS_HV70V()
{
  ...
  string outputname = "./figures/SignalTS_70V.pdf";
  ...
  string output_start = "./figures/SignalTS_70V.pdf[";
  ...
  string output_stop = "./figures/SignalTS_70V.pdf]";
