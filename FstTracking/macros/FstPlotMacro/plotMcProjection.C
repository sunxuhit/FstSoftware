...
void plotMcProjection(int sensorId = 0, string mod = "Mod03", string hv = "HV140V")
{
  ...
  //FST R-Phi
  c_Residual->cd(1);
  h_mFstProjXTalkResR_2Layer->SetTitle("FST");
  h_mFstProjXTalkResR_2Layer->GetXaxis()->SetTitle("r_{ro} - r_{proj} (mm)");
  h_mFstProjXTalkResR_2Layer->GetXaxis()->SetTitleSize(0.06);
  h_mFstProjXTalkResR_2Layer->GetXaxis()->CenterTitle();
  h_mFstProjXTalkResR_2Layer->GetXaxis()->SetRangeUser(-100.0,100.0);
  h_mFstProjXTalkResR_2Layer->SetLineStyle(1);
  h_mFstProjXTalkResR_2Layer->SetLineWidth(2);
  h_mFstProjXTalkResR_2Layer->SetLineColor(kGray+2);
  h_mFstProjXTalkResR_2Layer->Scale(NormR_InteData/NormR_InteMCXTalk);
  h_mFstProjXTalkResR_2Layer->GetYaxis()->SetRangeUser(0.0,NormR_InteData*1.1);
  h_mFstProjXTalkResR_2Layer->Draw("h");
  h_mFstProjResR_2Layer->SetLineStyle(2);
  h_mFstProjResR_2Layer->SetLineWidth(3);
  h_mFstProjResR_2Layer->SetLineColor(4);
  h_mFstProjResR_2Layer->Scale(NormR_InteData/NormR_InteMC);
  h_mFstProjResR_2Layer->Draw("h same");
  ...
  c_Residual->cd(2);
  h_mFstProjXTalkResPhi_2Layer->SetTitle("FST");
  h_mFstProjXTalkResPhi_2Layer->GetXaxis()->SetTitle("#phi_{ro} - #phi_{proj} (rad)");
  h_mFstProjXTalkResPhi_2Layer->GetXaxis()->SetTitleSize(0.06);
  h_mFstProjXTalkResPhi_2Layer->GetXaxis()->CenterTitle();
  h_mFstProjXTalkResPhi_2Layer->GetXaxis()->SetRangeUser(-0.05,0.05);
  h_mFstProjXTalkResPhi_2Layer->SetLineStyle(1);
  h_mFstProjXTalkResPhi_2Layer->SetLineWidth(2);
  h_mFstProjXTalkResPhi_2Layer->SetLineColor(kGray+2);
  h_mFstProjXTalkResPhi_2Layer->Scale(NormPhi_InteData/NormPhi_InteMCXTalk);
  h_mFstProjXTalkResPhi_2Layer->GetYaxis()->SetRangeUser(0.0,NormPhi_InteData*1.1);
  h_mFstProjXTalkResPhi_2Layer->Draw("h");
  h_mFstProjResPhi_2Layer->SetLineStyle(2);
  h_mFstProjResPhi_2Layer->SetLineWidth(3);
  h_mFstProjResPhi_2Layer->SetLineColor(4);
  h_mFstProjResPhi_2Layer->Scale(NormPhi_InteData/NormPhi_InteMC);
  h_mFstProjResPhi_2Layer->Draw("h same");
  ...
  for(int i_rstrp = 0; i_rstrp < 4; ++i_rstrp)
  {
    ...
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetTitle("r_{ro} - r_{proj} (mm)");
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetTitleSize(0.06);
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->GetXaxis()->CenterTitle();
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetRangeUser(-100.0,100.0);
    ...
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->GetYaxis()->SetRangeUser(0.0,NormR_Data[i_rstrp]*1.1);
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->SetLineStyle(1);
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->SetLineWidth(2);
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->SetLineColor(kGray+2);
    h_mFstProjXTalkResR_2Layer_Rstrips[i_rstrp]->Draw("h");
    ...
    h_mFstProjResR_2Layer_Rstrips[i_rstrp]->SetLineColor(4);
    h_mFstProjResR_2Layer_Rstrips[i_rstrp]->Draw("h same");
    ...
    h_mClustersTrackFstResR_2Layer_Rstrips[i_rstrp]->SetMarkerColor(1);
    ...
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetTitle("#phi_{ro} - #phi_{proj} (rad)");
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetTitleSize(0.06);
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->GetXaxis()->CenterTitle();
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->GetXaxis()->SetRangeUser(-0.05,0.05);
    ...
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->GetYaxis()->SetRangeUser(0.0,NormPhi_Data[i_rstrp]*1.1);
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->SetLineStyle(1);
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->SetLineWidth(2);
    h_mFstProjXTalkResPhi_2Layer_Rstrips[i_rstrp]->SetLineColor(kGray+2);
    ...
    h_mFstProjResPhi_2Layer_Rstrips[i_rstrp]->SetLineColor(4);
    h_mFstProjResPhi_2Layer_Rstrips[i_rstrp]->Draw("h same");
    ...
    h_mClustersTrackFstResPhi_2Layer_Rstrips[i_rstrp]->SetMarkerColor(1);
    h_mClustersTrackFstResPhi_2Layer_Rstrips[i_rstrp]->SetLineColor(1);
