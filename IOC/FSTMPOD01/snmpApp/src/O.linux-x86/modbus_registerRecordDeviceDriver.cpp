...
static const char * const deviceSupportNames[79] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[79] = {
...
int modbus_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 79, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"modbus_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
