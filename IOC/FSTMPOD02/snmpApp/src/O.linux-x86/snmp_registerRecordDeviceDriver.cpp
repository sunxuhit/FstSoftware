...
static const char * const deviceSupportNames[47] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[47] = {
...
epicsShareExtern void (*pvar_func_sncFGTRampingRegistrar)(void);
epicsShareExtern void (*pvar_func_sncFGTControlRegistrar)(void);
...
{
    const char *bldTop = "/home/sysuser/epics.3.14.12.1/hft_sc/IST/ISTMPOD02";
    ...
    registerDevices(pbase, 47, deviceSupportNames, devsl);
    (*pvar_func_asSub)();
    (*pvar_func_sncExampleRegistrar)();
    (*pvar_func_sncFGTRampingRegistrar)();
    (*pvar_func_sncFGTControlRegistrar)();
