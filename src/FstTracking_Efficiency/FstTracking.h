...
class FstTracking : public TObject
{
  ...
  private:
    ...
    int nProjected[5][8] = {0};
    int nMatched[5][8] = {0};
    TVectorT<double> *v_mMatchedHitEfficiency; // projection / track matching efficiency
    TVectorT<double> *v_mMatchedSimpleEfficiency_2Layer; // simple cluster matching efficiency
    TVectorT<double> *v_mMatchedSimpleEfficiency_3Layer;
    TVectorT<double> *v_mMatchedScanEfficiency_2Layer; // scan cluster matching efficiency
    TVectorT<double> *v_mMatchedScanEfficiency_3Layer;
