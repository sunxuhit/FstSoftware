...
//                  and V. Fine                                         //
//                                                                      //
// $Id: bfc_calib.C,v 1.2 2021/05/31 16:35:07 smirnovd Exp $
//////////////////////////////////////////////////////////////////////////
class StBFChain;
class StMessMgr;
...
void bfc_calib(Int_t First, Int_t Last,const Char_t *Chain = defChain + ",Display",
...
void bfc_calib(Int_t Last, const Char_t *Chain = defChain,
	 const Char_t *infile=0, const Char_t *outfile=0, const Char_t *TreeFile=0);
...
//_____________________________________________________________________
void bfc_calib(Int_t First, Int_t Last,
	 const Char_t *Chain,
	 const Char_t *infile,
...
#if 1
  gSystem->Load("libStIstUtil");
  gSystem->Load("libStIstRawHitMaker");
  gSystem->Load("libStIstCalibrationMaker");

  StIstRawHitMaker *istRawMk = chain->GetMaker("ist_raw_hit");
  istRawMk->setIsCalibrationMode(true); //calibration mode
  istRawMk->setDataType(1); //non-ZS ADC data type

  StIstCalibrationMaker *istCalibMk = chain->GetMaker("ist_calib");
  istCalibMk->setRunHist(true); //switch on histogram method
  istCalibMk->setPedCutFlag(true); //enbale pedestal cut to exclude signal event
...
void Usage() {
  printf ("============= \t U S A G E =============\n");
  printf ("bfc_calib(Int_t First,Int_t Last,const Char_t *Chain,const Char_t *infile,const Char_t *outfile,const Char_t *TreeFile)\n");
  printf ("bfc_calib(Int_t Last,const Char_t *Chain,const Char_t *infile,const Char_t *outfile,const Char_t *TreeFile)\n");
  printf ("bfc_calib(const Char_t *ChainShort,Int_t Last,const Char_t *infile,const Char_t *outfile)\n");
  printf ("where\n");
...
//_____________________________________________________________________
void bfc_calib(const Char_t *Chain="ittf") {
  bfc_calib(-2,Chain);
}
