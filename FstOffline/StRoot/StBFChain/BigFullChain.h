...
Bfc_st BFC[] = { // standard chains
  ...
  {"fstSlowSim", "", "","StMcEvent,StEvent,FstUtil", "StFstSlowSimMaker",
                                                             "StFstSimMaker", "FST Slow simulator", kFALSE},
  {"fstFastSim","","","StMcEvent,StEvent","StFstFastSimMaker","StFstSimMaker","FST Fast simulator", kFALSE},
  {"fstRawHit",  "", "", "fstUtil,fstDb","StFstRawHitMaker", "StFstRawHitMaker","FST RAWhit maker", kFALSE},
  {"fstCluster", "", "", "fstRawHit","StFstClusterMaker",  "StFstClusterMaker","FST Cluster maker", kFALSE},
  {"fstHit",     "", "", "event,fstCluster", "StFstHitMaker",       "StFstHitMaker","FST Hit Maker",kFALSE},
  {"fstUtil"     ,"","","","","StFstUtil","Fst Utilities",kFALSE},
  {"fstQA"    ,"","","fstUtil,StEvent"        ,"StFstQAMaker","StFstQAMaker","Example of Fst QA",kFALSE},
  {"fstCalib" ,"","","fstUtil","StFstCalibrationMaker","StFstCalibrationMaker","Fst Calibration Maker",kFALSE},
