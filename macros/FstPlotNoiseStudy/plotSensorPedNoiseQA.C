...
void plotSensorPedNoiseQA(string module = "Mod03", string hv = "HV70V")
{
  ...
  string outputname = Form("./figures/%s/PedNoiseQA_%s_%s.pdf",module.c_str(),module.c_str(),hv.c_str());
  ...
  string output_start = Form("./figures/%s/PedNoiseQA_%s_%s.pdf[",module.c_str(),module.c_str(),hv.c_str());
