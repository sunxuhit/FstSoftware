...
void plotResidual_FSTClusterTracks_2Layer_Rstrips(string hv = "HV140V", bool isSavePed = true, bool isApplyCMNCorr = true, float nFstHitsCut = 4.5, int numOfUsedTimeBins = 3)
{
  ...
  string outputname = "./figures/Residual_FSTClusterTracks_2Layer_Rstrips.pdf";
  
  string output_start = "./figures/Residual_FSTClusterTracks_2Layer_Rstrips.pdf[";
  ...
  string output_stop = "./figures/Residual_FSTClusterTracks_2Layer_Rstrips.pdf]"; 
