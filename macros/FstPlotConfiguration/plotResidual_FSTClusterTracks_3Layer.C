...
void plotResidual_FSTClusterTracks_3Layer(string hv = "HV200V", bool isSavePed = true, bool isApplyCMNCorr = true, float nFstHitsCut = 4.5, int numOfUsedTimeBins = 2, float nFstThresholdCut2 = 2.5, float nFstThresholdCut1 = 3.5)
{
  ...
  TH2F *h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[4]; 
    
  TH1F *h_mSimpleClustersTrackFstResR_3Layer_Rstrips[4];
  TH1F *h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[4];
  TH2F *h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[4];

  for(int i_rstrip = 0; i_rstrip < 4; ++i_rstrip)
  {
    string HistName;
    HistName = Form("h_mSimpleClustersTrackFstResX_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mSimpleClustersTrackFstResY_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mSimpleClustersTrackFstResXY_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip] = (TH2F*)File_InPut->Get(HistName.c_str());
  
    HistName = Form("h_mSimpleClustersTrackFstResR_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mSimpleClustersTrackFstResPhi_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrip%d",i_rstrip);
    h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip] = (TH2F*)File_InPut->Get(HistName.c_str());
  }
  ...
  TH2F *h_mScanClustersTrackFstResXY_3Layer_Rstrips[4]; 
    
  TH1F *h_mScanClustersTrackFstResR_3Layer_Rstrips[4];
  TH1F *h_mScanClustersTrackFstResPhi_3Layer_Rstrips[4];
  TH2F *h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[4];
  
  for(int i_rstrip = 0; i_rstrip < 4; ++i_rstrip)
  {
    string HistName;
    HistName = Form("h_mScanClustersTrackFstResX_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mScanClustersTrackFstResY_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mScanClustersTrackFstResXY_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip] = (TH2F*)File_InPut->Get(HistName.c_str());
  
    HistName = Form("h_mScanClustersTrackFstResR_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mScanClustersTrackFstResPhi_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip] = (TH1F*)File_InPut->Get(HistName.c_str());
    HistName = Form("h_mScanClustersTrackFstResRPhi_3Layer_Rstrip%d",i_rstrip);
    h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip] = (TH2F*)File_InPut->Get(HistName.c_str());
  }

  string outputname = "./figures/Residual_FSTClusterTracks_3Layer.pdf";
  ...
  string output_start = "./figures/Residual_FSTClusterTracks_3Layer.pdf[";
  ...
  { 
    ...
    string HistName;
    {
      ...
      h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->SetStats(0);
      h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("x-residual (mm)");
      h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("y-residual (mm)");
      h_mSimpleClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->Draw("colz");
      
      c_RStrip->cd(2)->Clear();
      c_RStrip->cd(2);
      HistName = Form("Corrected X-residual FST Simple Clusters Rstrip%d",i_rstrip);
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("x-residual (mm)");
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausX = new TF1("f_gausX",gaussian,-150.0,150.0,4);
      f_gausX->SetParameter(0,100.0);
      f_gausX->SetParameter(1,0.0);
      f_gausX->SetParameter(2,10.0);
      f_gausX->FixParameter(3,h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausX->SetRange(-20,50);
      h_mSimpleClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Fit(f_gausX,"R");
      f_gausX->Draw("l same");
  
      c_RStrip->cd(3)->Clear();
      c_RStrip->cd(3);
      HistName = Form("Corrected Y-residual FST Simple Clusters Rstrip%d",i_rstrip);
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("y-residual (mm)");
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausY = new TF1("f_gausY",gaussian,-150.0,150.0,4);
      f_gausY->SetParameter(0,100.0);
      f_gausY->SetParameter(1,0.0);
      f_gausY->SetParameter(2,10.0);
      f_gausY->FixParameter(3,h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausY->SetRange(-1.5,5);
      h_mSimpleClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Fit(f_gausY,"R");
      f_gausY->Draw("l same");
      
      c_RStrip->cd(4)->Clear();
      c_RStrip->cd(4);
      HistName = Form("Corrected R & #phi Residual FST Simple Clusters Rstrip%d",i_rstrip);
      h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->SetStats(0);
      h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("r-residual (mm)");
      h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("#phi-residual (rad)");
      h_mSimpleClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->Draw("colz");
  
      c_RStrip->cd(5)->Clear();
      c_RStrip->cd(5);
      HistName = Form("Corrected R-residual FST Simple Clusters Rstrip%d",i_rstrip);
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("r-residual (mm)");
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausR = new TF1("f_gausR",gaussian,-150.0,150.0,4);
      f_gausR->SetParameter(0,100.0);
      f_gausR->SetParameter(1,0.0);
      f_gausR->SetParameter(2,10.0);
      f_gausR->FixParameter(3,h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausR->SetRange(-20,50);
      h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->Fit(f_gausR,"R");
      f_gausR->Draw("l same");
      // gPad->Update();
      // TPaveStats *st1 = (TPaveStats*)h_mSimpleClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->FindObject("stats");
      // st1->SetOptStat(111111);
      // st1->SetX1NDC(0.6);
      // st1->SetX2NDC(0.9);
      ...
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("#phi-residual (rad)");
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausPhi = new TF1("f_gausPhi",gaussian,-1.0,1.0,4);
      f_gausPhi->SetParameter(0,100.0);
      f_gausPhi->SetParameter(1,0.0);
      f_gausPhi->SetParameter(2,10.0);
      ...
      // f_gausPhi->SetParName(1,"Mean");
      // f_gausPhi->SetParName(2,"#sigma");
      f_gausPhi->FixParameter(3,h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausPhi->SetRange(-0.01,0.01);
      h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->Fit(f_gausPhi,"R");
      f_gausPhi->Draw("l same");
      // gPad->Update();
      // TPaveStats *st2 = (TPaveStats*)h_mSimpleClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->FindObject("stats");
      // st2->SetOptStat(110011);
    }
  
    {
      ...
      h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->SetStats(0);
      h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("x-residual (mm)");
      h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("y-residual (mm)");
      h_mScanClustersTrackFstResXY_3Layer_Rstrips[i_rstrip]->Draw("colz");
      
      c_RStrip->cd(8)->Clear();
      c_RStrip->cd(8);
      HistName = Form("Corrected X-residual FST Scan Clusters Rstrip%d",i_rstrip);
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("x-residual (mm)");
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausX = new TF1("f_gausX",gaussian,-150.0,150.0,4);
      f_gausX->SetParameter(0,100.0);
      f_gausX->SetParameter(1,0.0);
      f_gausX->SetParameter(2,10.0);
      f_gausX->FixParameter(3,h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausX->SetRange(-20,50);
      h_mScanClustersTrackFstResX_3Layer_Rstrips[i_rstrip]->Fit(f_gausX,"R");
      f_gausX->Draw("l same");
      
      c_RStrip->cd(9)->Clear();
      c_RStrip->cd(9);
      HistName = Form("Corrected Y-residual FST Scan Clusters Rstrip%d",i_rstrip);
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("y-residual (mm)");
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Draw();
      // h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Fit("gaus");
      TF1 *f_gausY = new TF1("f_gausY",gaussian,-150.0,150.0,4);
      f_gausY->SetParameter(0,100.0);
      f_gausY->SetParameter(1,0.0);
      f_gausY->SetParameter(2,10.0);
      f_gausY->FixParameter(3,h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausY->SetRange(-1.5,5);
      h_mScanClustersTrackFstResY_3Layer_Rstrips[i_rstrip]->Fit(f_gausY,"R");
      f_gausY->Draw("l same");
      
      c_RStrip->cd(10)->Clear();
      c_RStrip->cd(10);
      HistName = Form("Corrected R & #phi Residual FST Scan Clusters Rstrip%d",i_rstrip);
      h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->SetStats(0);
      h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("r-residual (mm)");
      h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("#phi-residual (rad)");
      h_mScanClustersTrackFstResRPhi_3Layer_Rstrips[i_rstrip]->Draw("colz");
      
      c_RStrip->cd(11)->Clear();
      c_RStrip->cd(11);
      HistName = Form("Corrected R-residual FST Scan Clusters Rstrip%d",i_rstrip);
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("r-residual (mm)");
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->Draw();
      TF1 *f_gausR = new TF1("f_gausR",gaussian,-150.0,150.0,4);
      f_gausR->SetParameter(0,100.0);
      f_gausR->SetParameter(1,0.0);
      f_gausR->SetParameter(2,10.0);
      f_gausR->FixParameter(3,h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausR->SetRange(-20,50);
      h_mScanClustersTrackFstResR_3Layer_Rstrips[i_rstrip]->Fit(f_gausR,"R");
      f_gausR->Draw("l same");
      
      c_RStrip->cd(12)->Clear();
      c_RStrip->cd(12);
      HistName = Form("Corrected #phi-residual FST Scan Clusters Rstrip%d",i_rstrip);
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->SetTitle(HistName.c_str());
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitle("#phi-residual (rad)");
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetXaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitle("No. Tracks");
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetYaxis()->SetTitleSize(0.06);
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->Draw();
      TF1 *f_gausPhi = new TF1("f_gausPhi",gaussian,-1.0,1.0,4);
      f_gausPhi->SetParameter(0,100.0);
      f_gausPhi->SetParameter(1,0.0);
      f_gausPhi->SetParameter(2,10.0);
      f_gausPhi->FixParameter(3,h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->GetBinWidth(1));
      f_gausPhi->SetRange(-0.01,0.01);
      h_mScanClustersTrackFstResPhi_3Layer_Rstrips[i_rstrip]->Fit(f_gausPhi,"R");
      f_gausPhi->Draw("l same");
    }
    c_RStrip->Update();
  ...
  string output_stop = "./figures/Residual_FSTClusterTracks_3Layer.pdf]"; 
