...
void calTrackHitEfficiency()
{
  ...
  TH2F *h_mTrackHits_IST = (TH2F*)File_InPut->Get("h_mTrackHits_IST");
  h_mTrackHits_IST->Sumw2();
  TH1F *h_mR_IST = (TH1F*)h_mTrackHits_IST->ProjectionX("h_mR_IST");
  TH1F *h_mPhi_IST = (TH1F*)h_mTrackHits_IST->ProjectionY("h_mPhi_IST");

  TH2F *h_mTrackHits_FST = (TH2F*)File_InPut->Get("h_mTrackHits_FST");
  h_mTrackHits_FST->Sumw2();
  TH1F *h_mR_FST = (TH1F*)h_mTrackHits_FST->ProjectionX("h_mR_FST");
  TH1F *h_mPhi_FST = (TH1F*)h_mTrackHits_FST->ProjectionY("h_mPhi_FST");

  TH2F *h_mEfficiency = (TH2F*)h_mTrackHits_IST->Clone("h_mEfficiency");
  h_mEfficiency->SetTitle("h_mEfficiency");
  h_mEfficiency->Reset();
  h_mEfficiency->Divide(h_mTrackHits_FST,h_mTrackHits_IST,1,1,"B");
  ...
  c_play->cd(1);
  h_mTrackHits_IST->GetXaxis()->SetTitle("r_{proj} (mm)");
  h_mTrackHits_IST->GetYaxis()->SetTitle("phi_{proj} (rad)");
  h_mTrackHits_IST->Draw("colz");
  ...
  c_play->cd(4);
  h_mTrackHits_FST->GetXaxis()->SetTitle("r_{proj} (mm)");
  h_mTrackHits_FST->GetYaxis()->SetTitle("phi_{proj} (rad)");
  h_mTrackHits_FST->Draw("colz");
