...
then
  ...
  root -l -b -q doFstTracking_timesequence.C\(\"HV70V\",\"${config}\",${isSavePed},\"04162020\"\)

  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"03202020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"03292020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"03302020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"03312020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04022020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04032020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04042020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04062020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04072020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04082020\"\)
  ...
  root -l -b -q doFstTracking_timesequence.C\(\"HV200V\",\"${config}\",${isSavePed},\"04092020\"\)
  root -l -b -q doFstTracking_timesequence.C\(\"HV200V\",\"${config}\",${isSavePed},\"04122020\"\)
