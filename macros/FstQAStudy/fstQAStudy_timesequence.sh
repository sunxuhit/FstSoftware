...
then
  ...
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04272020\"\)
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"04292020\"\)
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"05022020\"\)
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV140V\",\"${config}\",${isSavePed},\"05042020\"\)
  ...
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV200V\",\"${config}\",${isSavePed},\"04242020\"\)
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV200V\",\"${config}\",${isSavePed},\"04252020\"\)
  root -l -b -q doFstQAStudy_timesequence.C\(\"HV200V\",\"${config}\",${isSavePed},\"04262020\"\)
fi
