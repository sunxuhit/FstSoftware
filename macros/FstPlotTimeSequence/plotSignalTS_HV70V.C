...
{
  const int numOfTS = 5;
  string date[numOfTS] = {"0318","0410","0411","0414","0416"};
  ...
  {
    string inputfile = Form("../../output/timesequence/FstQAStudy_HV70V_withPed_Th4o5Tb3_%s2020.root",date[i_ts].c_str());
    ...
    for(int i_rstrip = 0; i_rstrip < 4; ++i_rstrip)
    {
      ...
      h_mSignalClusters_Rstrip[i_ts][i_rstrip] = (TH1F*)File_InPut[i_ts]->Get(HistName.c_str());
    }
  }
  ...
  c_Signal_TS->cd(1);
  {
	...
	h_mMeanSignalHits_Rstrip[i_rstrip]->GetXaxis()->SetBinLabel(i_ts+1,date[i_ts].c_str());
      ...
      h_mMeanSignalHits_Rstrip[i_rstrip]->GetYaxis()->SetTitle("#frac{<ADC>_{Hits}}{<ADC>_{Hits @ 0318}}");
  ...
  c_Signal_TS->cd(2);
  {
	...
	h_mMeanSignalClusters_Rstrip[i_rstrip]->GetXaxis()->SetBinLabel(i_ts+1,date[i_ts].c_str());
      ...
      h_mMeanSignalClusters_Rstrip[i_rstrip]->GetYaxis()->SetTitle("#frac{<ADC>_{Clusters}}{<ADC>_{Clusters @ 0318}}");
  ...
  c_Signal_TS->cd(3);
  {
	...
	h_mMeanNoiseHits_Rstrip[i_rstrip]->GetXaxis()->SetBinLabel(i_ts+1,date[i_ts].c_str());
      ...
      h_mMeanNoiseHits_Rstrip[i_rstrip]->GetYaxis()->SetTitle("Noise #frac{<ADC>_{Hits}}{<ADC>_{Hits @ 0318}}");
  ...
  c_Signal_TS->cd(4);
  {
	...
	h_mMeanSNRatioHits_Rstrip[i_rstrip]->GetXaxis()->SetBinLabel(i_ts+1,date[i_ts].c_str());
      ...
      h_mMeanSNRatioHits_Rstrip[i_rstrip]->GetYaxis()->SetTitle("#frac{<Signal/Noise>_{Hits}}{<Signal/Noise>_{Hits @ 0318}}");
  ...
  c_Signal_TS->cd(5);
  {
	...
	h_mMeanMaxTbHits_Rstrip[i_rstrip]->GetXaxis()->SetBinLabel(i_ts+1,date[i_ts].c_str());
      ...
      h_mMeanMaxTbHits_Rstrip[i_rstrip]->GetYaxis()->SetTitle("#frac{<Max Time Bin>_{Hits}}{<Max Time Bin>_{Hits @ 0318}}");
